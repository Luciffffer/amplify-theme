        ...
        <footer class="text-white">
            ...
            <div class="bg-[#0D1117] px-12">
                <div class="bg-[#0D1117] max-w-7xl w-full mx-auto py-6 flex flex-col gap-6 items-center text-body-sm text-[#FBFBFB] md:flex-row md:justify-between">
